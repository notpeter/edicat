...
from typing import TypedDict, Optional, Protocol, TypeVar
...
def readdocument(edi_obj: Union[str, BufferedReader], filename: str = 'stream', encoding: str ='latin-1') -> Iterator[str]:
